package com.lelestacia.more.component
        ...
        Column(
            ...
            Text(
                text = when (selectedStyle) {
                    DisplayStyle.CARD -> stringResource(id = com.lelestacia.common.R.string.card)
                    DisplayStyle.COMPACT_CARD -> stringResource(id = com.lelestacia.common.R.string.compact_card)
                    DisplayStyle.LIST -> stringResource(id = com.lelestacia.common.R.string.list)
                },
